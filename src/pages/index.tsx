...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Vehicle Toll Payment System`}</title>

        <meta
          name="description"
          content="Vehicle Toll Payment System: Streamlining Your Journey with Our Cloud-Based Solution for Easy and Efficient Toll Payments"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1541348263662-e068662d82af?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx2ZWhpY2xlfGVufDB8fHx8MTY5ODQxMjI3N3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Vehicle Toll Payment System: Streamlining Your Journey with Our Cloud-Based Solution for Easy and Efficient Toll Payments`}
            </Text>
            <Box
