...
import { useTollFindFirst, useRoqClient } from 'lib/roq';
...
function TollViewPage() {
  ...
  const { data, error, isLoading } = useTollFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('toll', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/tolls/edit/${id}`} passHref legacyBehavior>
                    <Button
