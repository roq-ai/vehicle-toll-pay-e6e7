...
export function useTollFindMany<
  T extends Prisma.tollFindManyArgs,
  R extends GetFindResult<Prisma.$tollPayload<DefaultArgs>, T>[],
>(args?: Prisma.SelectSubset<T, Prisma.tollFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useTollFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.toll.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTollCount<T extends Prisma.tollCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.tollCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useTollCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.toll.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTollFindManyWithCount<
  T extends Prisma.tollFindManyArgs,
  R extends { data: GetFindResult<Prisma.$tollPayload<DefaultArgs>, T>[]; count: number },
>(args?: Prisma.SelectSubset<T, Prisma.tollFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useTollFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.toll.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTollFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useTollFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.toll.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
