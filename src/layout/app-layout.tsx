...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['system-owner', 'system-administrator', 'customer-service-representative'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Tolls', path: '/tolls', entity: 'toll', service: AccessServiceEnum.PROJECT, icon: FiMapPin },
    {
      name: 'Transactions',
      path: '/transactions',
      entity: 'transaction',
